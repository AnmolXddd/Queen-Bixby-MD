...
/*
    case 'Gm': case'gm': case 'Good morning': {
        result = fs.readFileSync(`./BixbyMedia/sticker/gm.webp`)
		GojoMdNx.sendMessage(m.chat, { sticker: result }, { quoted: m })
                }
...
│ 
┃║⚜️  Total: ${vote[m.chat][1].length}
${vote[m.chat][1].map((v, i) => `┃║⚜️  ${i + 1}. @${v.split`@`[0]}`).join('\n')}
│ 
└────
...
│ 
┃║⚜️  Total: ${vote[m.chat][2].length}
${vote[m.chat][2].map((v, i) => `┃║⚜️  ${i + 1}. @${v.split`@`[0]}`).join('\n')}
│ 
└────
...
`,
		    ...
		    anu.media.map(async (url) => {
		        GojoMdNx.sendMessage(m.chat, { image: { url }, caption: `⚜️ Title : ${anu.title}\n⚜️ Author : ${anu.author.name}\n⚜️ Like : ${anu.like}\n⚜️ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
┏━❦${botname} ❦━━⭓ 
┃╔═✪❦TEXT PRO ❦	        
┃║⚜️  ${prefix}3dchristmas [txt]
┃║⚜️  ${prefix}3ddeepsea [txt]
┃║⚜️  ${prefix}americanflag [txt]
┃║⚜️  ${prefix}3dscifi [txt]
┃║⚜️  ${prefix}3drainbow [txt]
┃║⚜️  ${prefix}3dwaterpipe [txt]
┃║⚜️  ${prefix}halloweenskeleton [txt]
┃║⚜️  ${prefix}sketch [txt]
┃║⚜️  ${prefix}bluecircuit [txt]
┃║⚜️  ${prefix}space [txt]
┃║⚜️  ${prefix}metallic [txt]
┃║⚜️  ${prefix}fiction [txt]
┃║⚜️  ${prefix}greenhorror [txt]
┃║⚜️  ${prefix}transformer [txt]
┃║⚜️  ${prefix}berry [txt]
┃║⚜️  ${prefix}thunder [txt]
┃║⚜️  ${prefix}magma [txt]
┃║⚜️  ${prefix}3dcrackedstone [txt]
┃║⚜️  ${prefix}3dneonlight [txt]
┃║⚜️  ${prefix}impressiveglitch [txt]
┃║⚜️  ${prefix}naturalleaves [txt]
┃║⚜️  ${prefix}fireworksparkle [txt]
┃║⚜️  ${prefix}matrix [txt]
┃║⚜️  ${prefix}dropwater [txt]
┃║⚜️  ${prefix}harrypotter [txt]
┃║⚜️  ${prefix}foggywindow [txt]
┃║⚜️  ${prefix}neondevils [txt]
┃║⚜️  ${prefix}christmasholiday [txt]
┃║⚜️  ${prefix}3dgradient [txt]
┃║⚜️  ${prefix}blackpink [txt]
┃║⚜️  ${prefix}gluetext [txt]
┃╚═════════════✪
┗━━❦${pushname} ❦━⭓`,unicorn, [{"urlButton": {"displayText": "YOUTUBE","url": `${myweb}`}},{"urlButton": {"displayText": "GIT HUB","url": `${sc}`}},{"quickReplyButton": {"displayText": "DONATE","id": 'donate'}},{"quickReplyButton": {"displayText": "OWNER","id": 'owner'}}] )
break
case 'convertmenu':
...
┏━❦${botname} ❦━━⭓ 
┃╔══✪❦CONVERTER ❦	        
┃║⚜️  ${prefix}photo [reply to sticker]
┃║⚜️  ${prefix}sticker [reply img|gif]
┃║⚜️  ${prefix}emojimix [moji+moji]
┃║⚜️  ${prefix}tovideo [reply img]
┃║⚜️  ${prefix}togif [reply stick]
┃║⚜️  ${prefix}tourl [reply media]
...
And Again Me (Thinura) ⚜️ Who Helped Assemble This Script !!!`,unicorn, [{"urlButton": {"displayText": "YOUTUBE","url": `${myweb}`}},{"urlButton": {"displayText": "GIT HUB","url": `${sc}`}},{"quickReplyButton": {"displayText": "DONATE","id": 'donate'}},{"quickReplyButton": {"displayText": "OWNER","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
